...
// classe qye vai cibter a lógica dos dados
...
export class Favorites {
  ...
  delete(user) {
    ...
    // esta funcao retorna aquela lista filtrada, se eu marcar o user como false ele nao aparece nesta lista
...
export class FavoritesView extends Favorites {
  constructor(root) {
    ...
    this.onAdd()
    // GithubUser.searchUser('leobhxp').then(user => console.log(user))
  ...
  onAdd() {
    ...
    addButton.onclick = () => {
      ...
      // o console.dir ele imprime como objeto mesmo
      // console.dir(input)
      console.log(value)
      this.add(value)
    }
